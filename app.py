...
class Application:
    def __init__(self, master):
        ...
        self.weights_entry.grid(row=0, column=1, sticky="nsew", padx=(10, 0), pady=15)
        ...
        self.source_entry.grid(row=0, column=3, sticky="nsew", padx=(10, 0), pady=15)
        ...
        self.data_entry.grid(row=1, column=1, sticky="nsew", padx=(10, 0), pady=15)
        ...
        self.imgsz_entry.grid(row=1, column=3, sticky="nsew", padx=(10, 0), pady=15)
        ...
        self.conf_thres_entry.grid(
            row=2, column=1, sticky="nsew", padx=(10, 0), pady=15
        )

        self.iou_thres_label = ctk.CTkLabel(self.left_frame, text="NMS IOU Threshold:")
        self.iou_thres_label.grid(row=2, column=0, sticky="nsew", padx=(10, 0), pady=15)
        ...
        self.max_det_entry.grid(row=3, column=1, sticky="nsew", padx=(10, 0), pady=15)

        self.device_label = ctk.CTkLabel(self.left_frame, text="Device:")
        self.device_label.grid(row=3, column=0, sticky="nsew", padx=(10, 0), pady=15)
        self.device_entry = ctk.CTkEntry(self.left_frame)
        self.device_entry.grid(row=3, column=1, sticky="nsew", padx=(10, 0), pady=15)
        ...
        self.save_txt_entry.grid(row=4, column=1, sticky="nsew", padx=(10, 0), pady=15)
        ...
        self.save_conf_entry.grid(
            row=5, column=1, sticky="nsew", padx=(10, 0), pady=15
        )
        ...
        self.nosave_label.grid(row=6, column=0, sticky="nsew", padx=(10, 0), pady=15)
        self.nosave_entry = ctk.CTkEntry(self.left_frame)
        self.nosave_entry.grid(row=6, column=1, sticky="nsew", padx=(10, 0), pady=15)
        ...
        self.augment_entry.grid(row=7, column=1, sticky="nsew", padx=(10, 0), pady=15)
